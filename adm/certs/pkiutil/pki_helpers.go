...
func GetAPIServerAltNames(cfg *admapi.MasterConfiguration) (*certutil.AltNames, error) {
	// advertise address
	...
	appendSANsToAltNames(altNames, cfg.APIServerCertSANs, admconstants.APIServerCertName)
...
func GetEtcdAltNames(cfg *admapi.MasterConfiguration) (*certutil.AltNames, error) {
	// create AltNames with defaults DNSNames/IPs
	altNames := &certutil.AltNames{
	...
	appendSANsToAltNames(altNames, cfg.Etcd.ServerCertSANs, admconstants.EtcdServerCertName)
...
func GetEtcdPeerAltNames(cfg *admapi.MasterConfiguration) (*certutil.AltNames, error) {
	// advertise address
	advertiseAddress := net.ParseIP(cfg.API.AdvertiseAddress)
	if advertiseAddress == nil {
		return nil, fmt.Errorf("error parsing API AdvertiseAddress %v: is not a valid textual representation of an IP address", cfg.API.AdvertiseAddress)
	...
	appendSANsToAltNames(altNames, cfg.Etcd.PeerCertSANs, admconstants.EtcdPeerCertName)
