...
import (
	...
	"github.com/jmpq/cloud10x/adm/certs/pkiutil"
	admconstants "github.com/jmpq/cloud10x/adm/constants"
	certutil "k8s.io/client-go/util/cert"
)

// CreatePKIAssets will create and write to disk all PKI assets necessary to establish the control plane.
// If the PKI assets already exists in the target folder, they are used only if evaluated equal; otherwise an error is returned.
func CreatePKIAssets(cfg *admapi.MasterConfiguration) error {

	certActions := []func(cfg *admapi.MasterConfiguration) error{
...
func CreateCACertAndKeyFiles(cfg *admapi.MasterConfiguration) error {
	...
	return writeCertificateAuthorithyFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.CACertAndKeyBaseName,
		caCert,
		caKey,
	)
}
...
func CreateAPIServerCertAndKeyFiles(cfg *admapi.MasterConfiguration) error {

	caCert, caKey, err := loadCertificateAuthority(cfg.CertificatesDir, admconstants.CACertAndKeyBaseName)
	if err != nil {
		return err
	}
	...
	return writeCertificateFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.APIServerCertAndKeyBaseName,
		caCert,
		apiCert,
		apiKey,
	)
...
// It assumes the cluster CA certificate and key files exist in the CertificatesDir.
func CreateAPIServerKubeletClientCertAndKeyFiles(cfg *admapi.MasterConfiguration) error {
	...
	return writeCertificateFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.APIServerKubeletClientCertAndKeyBaseName,
		caCert,
...
func CreateEtcdCACertAndKeyFiles(cfg *admapi.MasterConfiguration) error {
	...
	return writeCertificateAuthorithyFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.EtcdCACertAndKeyBaseName,
		etcdCACert,
		etcdCAKey,
	)
}
...
func CreateEtcdServerCertAndKeyFiles(cfg *admapi.MasterConfiguration) error {

	etcdCACert, etcdCAKey, err := loadCertificateAuthority(cfg.CertificatesDir, admconstants.EtcdCACertAndKeyBaseName)
	if err != nil {
		return err
	}
	...
	return writeCertificateFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.EtcdServerCertAndKeyBaseName,
		etcdCACert,
		etcdServerCert,
		etcdServerKey,
	)
...
// It assumes the etcd CA certificate and key file exist in the CertificatesDir
func CreateEtcdPeerCertAndKeyFiles(cfg *admapi.MasterConfiguration) error {
	...
	return writeCertificateFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.EtcdPeerCertAndKeyBaseName,
		etcdCACert,
		etcdPeerCert,
		etcdPeerKey,
	)
...
// It assumes the etcd CA certificate and key file exist in the CertificatesDir
func CreateAPIServerEtcdClientCertAndKeyFiles(cfg *admapi.MasterConfiguration) error {
	...
	return writeCertificateFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.APIServerEtcdClientCertAndKeyBaseName,
		etcdCACert,
		apiEtcdClientCert,
		apiEtcdClientKey,
	)
...
func CreateServiceAccountKeyAndPublicKeyFiles(cfg *admapi.MasterConfiguration) error {
	...
	return writeKeyFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.ServiceAccountKeyBaseName,
		saSigningKey,
	)
}
...
func CreateFrontProxyCACertAndKeyFiles(cfg *admapi.MasterConfiguration) error {
	...
	return writeCertificateAuthorithyFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.FrontProxyCACertAndKeyBaseName,
		frontProxyCACert,
		frontProxyCAKey,
	)
}
...
func CreateFrontProxyClientCertAndKeyFiles(cfg *admapi.MasterConfiguration) error {

	frontProxyCACert, frontProxyCAKey, err := loadCertificateAuthority(cfg.CertificatesDir, admconstants.FrontProxyCACertAndKeyBaseName)
	if err != nil {
		return err
	}
	...
	return writeCertificateFilesIfNotExist(
		cfg.CertificatesDir,
		admconstants.FrontProxyClientCertAndKeyBaseName,
		frontProxyCACert,
...
func NewAPIServerCertAndKey(cfg *admapi.MasterConfiguration, caCert *x509.Certificate, caKey *rsa.PrivateKey) (*x509.Certificate, *rsa.PrivateKey, error) {
	...
	config := certutil.Config{
		CommonName: admconstants.APIServerCertCommonName,
		AltNames:   *altNames,
...
func NewAPIServerKubeletClientCertAndKey(caCert *x509.Certificate, caKey *rsa.PrivateKey) (*x509.Certificate, *rsa.PrivateKey, error) {
	...
	config := certutil.Config{
		CommonName:   admconstants.APIServerKubeletClientCertCommonName,
		Organization: []string{admconstants.MastersGroup},
...
func NewEtcdServerCertAndKey(cfg *admapi.MasterConfiguration, caCert *x509.Certificate, caKey *rsa.PrivateKey) (*x509.Certificate, *rsa.PrivateKey, error) {
	...
	config := certutil.Config{
		CommonName: admconstants.EtcdServerCertCommonName,
		AltNames:   *altNames,
		Usages:     []x509.ExtKeyUsage{x509.ExtKeyUsageServerAuth},
	}
...
func NewEtcdPeerCertAndKey(cfg *admapi.MasterConfiguration, caCert *x509.Certificate, caKey *rsa.PrivateKey) (*x509.Certificate, *rsa.PrivateKey, error) {
	...
	config := certutil.Config{
		CommonName: admconstants.EtcdPeerCertCommonName,
		AltNames:   *altNames,
...
func NewAPIServerEtcdClientCertAndKey(caCert *x509.Certificate, caKey *rsa.PrivateKey) (*x509.Certificate, *rsa.PrivateKey, error) {
	...
	config := certutil.Config{
		CommonName:   admconstants.APIServerEtcdClientCertCommonName,
		Organization: []string{admconstants.MastersGroup},
		Usages:       []x509.ExtKeyUsage{x509.ExtKeyUsageClientAuth},
	}
	apiClientCert, apiClientKey, err := pkiutil.NewCertAndKey(caCert, caKey, config)
...
func NewFrontProxyClientCertAndKey(frontProxyCACert *x509.Certificate, frontProxyCAKey *rsa.PrivateKey) (*x509.Certificate, *rsa.PrivateKey, error) {
	...
	config := certutil.Config{
		CommonName: admconstants.FrontProxyClientCertCommonName,
		Usages:     []x509.ExtKeyUsage{x509.ExtKeyUsageClientAuth},
	}
...
func UsingExternalCA(cfg *admapi.MasterConfiguration) (bool, error) {

	if err := validateCACert(certKeyLocation{cfg.CertificatesDir, admconstants.CACertAndKeyBaseName, "", "CA"}); err != nil {
		return false, err
	}

	caKeyPath := filepath.Join(cfg.CertificatesDir, admconstants.CAKeyName)
	if _, err := os.Stat(caKeyPath); !os.IsNotExist(err) {
		return false, fmt.Errorf("ca.key exists")
	}

	if err := validateSignedCert(certKeyLocation{cfg.CertificatesDir, admconstants.CACertAndKeyBaseName, admconstants.APIServerCertAndKeyBaseName, "API server"}); err != nil {
		return false, err
	}

	if err := validateSignedCert(certKeyLocation{cfg.CertificatesDir, admconstants.CACertAndKeyBaseName, admconstants.APIServerKubeletClientCertAndKeyBaseName, "API server kubelet client"}); err != nil {
		return false, err
	}

	if err := validatePrivatePublicKey(certKeyLocation{cfg.CertificatesDir, "", admconstants.ServiceAccountKeyBaseName, "service account"}); err != nil {
		return false, err
	}

	if err := validateCACertAndKey(certKeyLocation{cfg.CertificatesDir, admconstants.FrontProxyCACertAndKeyBaseName, "", "front-proxy CA"}); err != nil {
		return false, err
	}

	if err := validateSignedCert(certKeyLocation{cfg.CertificatesDir, admconstants.FrontProxyCACertAndKeyBaseName, admconstants.FrontProxyClientCertAndKeyBaseName, "front-proxy client"}); err != nil {
		return false, err
	}
